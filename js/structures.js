...
function disposeStructureGroup(root){if(!root)return;const geometries=new Set(),materials=new Set(),textures=new Set();
...
if(typeof module!=='undefined')module.exports={validateStructureData,disposeStructureGroup};
